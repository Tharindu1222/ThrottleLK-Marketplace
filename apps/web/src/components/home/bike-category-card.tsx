...
export function BikeCategoryCard({
  ...
  return (
    <Link
      ...
      className="group relative block h-[220px] overflow-hidden border border-white/10 bg-surface transition duration-500 ease-out hover:-translate-y-1.5 hover:border-accent hover:shadow-[0_20px_40px_-20px_rgba(225,6,0,0.45)] sm:h-[240px] lg:h-[260px]"
    >
      ...
      <div className="relative flex h-full flex-col justify-end p-4 sm:p-5">
        <div className="flex items-end justify-between gap-3">
          ...
          <span
            aria-hidden
            className="mb-1 flex h-8 w-8 shrink-0 items-center justify-center border border-white/15 text-foreground/70 transition duration-300 group-hover:translate-x-0.5 group-hover:border-accent group-hover:bg-accent group-hover:text-white"
          >
