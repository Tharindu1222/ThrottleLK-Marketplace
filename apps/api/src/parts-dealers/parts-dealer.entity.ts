...
@Entity('parts_dealers')
@Index('IDX_parts_dealers_status_name', ['status', 'name'])
@Index('IDX_parts_dealers_owner_user_id', ['ownerUserId'])
export class PartsDealer {
  ...
  @OneToMany(() => PartsDealerImage, (image) => image.partsDealer)
  images!: PartsDealerImage[];
}
