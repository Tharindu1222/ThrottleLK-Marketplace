...
function ApplyIntro({
  ...
  locale: Locale;
  title: 'becomeDealer' | 'yourBikeDealer';
  hint: 'becomeDealerHint' | 'becomeDealerExistingHint';
}) {
  return (
    <div className="mb-8">
  ...
  if (owned) {
    return (
      <>
        <ApplyIntro
          locale={locale}
          title="yourBikeDealer"
          hint="becomeDealerExistingHint"
        />
        <OwnedDealerStatus locale={locale} kind="bike" dealer={owned} ok={ok} />
      </>
    );
  }
